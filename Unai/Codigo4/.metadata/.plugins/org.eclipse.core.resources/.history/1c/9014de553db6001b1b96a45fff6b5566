 ...
 * @author unaif
 */
public class AnadirEvento extends javax.swing.JPanel {
     ...
     */
    public AnadirEvento(VentanaPrincipal jf) {
        initComponents(jf);
    }
   ...
   private void initComponents(VentanaPrincipal jf) {
        ...
        jLabel1.setText("Introducir Evento");
        ...
        jButtonEnviar.setText("Crear");
        jButtonEnviar.addActionListener(new GuardarEvento(this, 3, jf, jTextField1, jTextField2, jTextArea1));
