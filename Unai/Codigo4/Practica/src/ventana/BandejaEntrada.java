...
private void initComponents(VentanaPrincipal jf) {
        ...
        Image conversion = imagen_redactar.getImage();
        ...
        conversion = imagen_opciones.getImage();
        conversion = conversion.getScaledInstance(50, 50, Image.SCALE_SMOOTH);
        ...
        jLabel1.setText("Remitente: Nicolás Luís Fernández García");

        jLabel2.setText("Asunto: Contrucción del conjunto primero: ejercicio de la página 295 del tema 4.");
        ...
        jLabel3.setText("Remitente: epsc.secretaria@uco.es");

        jLabel4.setText("Asunto: Oferta de Prácticas de FUNDECOR.");
        ...
        jLabel5.setText("Remitente: Antonio Arauzo Azofra");

        jLabel6.setText("Asunto: Antonio Arauzo Azofra ha hecho un comentario en la tarea Hand in text Unit 7 Class Activity.");
        ...
        jLabel7.setText("Remitente: José María Luna Ariza");

        jLabel8.setText("Asunto: Lab-First assignment.");
        ...
        jLabel9.setText("Remitente: José María Moyano Murillo");

        jLabel10.setText("Asunto: Sondeo asistencia presencial a clase de prácticas.");
